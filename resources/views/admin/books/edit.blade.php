        ...
        <div class="card">
            ...
            <form action="{{ route('books.update', $book->id) }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('book_type') is-invalid @enderror" id="book_type" name="book_type" value="{{ $book->book_type }}">
                    @error('book_type')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('location') is-invalid @enderror" id="location" name="location" value="{{ $book->location }}">
                    @error('location')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('instock') is-invalid @enderror" id="instock" name="instock" value="{{ $book->instock }}">
                    @error('instock')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('cost') is-invalid @enderror" id="cost" name="cost" value="{{ $book->cost }}">
                    @error('cost')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
